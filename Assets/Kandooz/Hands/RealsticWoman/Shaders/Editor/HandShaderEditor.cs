...
namespace Kandooz
{
    public class HandShaderEditor : ShaderGUI
    {
        ...
        private MaterialProperty _FingerTips=null;
        private MaterialProperty _NailColor=null;
        ...
        void GetProperties()
        {
            ...
            _FingerTips=FindProperty("_FingerTips", _properties);
            _NailColor=FindProperty("_NailsColor", _properties);
        ...
        private void DrawGeneralSettings()
        {
            ...
            _materialEditor.ShaderProperty(_NailColor, "NailsColor");
        }
        ...
        void DrawTextureSettings()
        {
            ...
            _materialEditor.TexturePropertySingleLine(new GUIContent("Albedo"), _HandAlbedo);
            _materialEditor.TexturePropertySingleLine(new GUIContent("Normal"), _HandNormal);
            _materialEditor.TexturePropertySingleLine(new GUIContent("Combined Map"), _HandCombined);
            _materialEditor.TexturePropertySingleLine(new GUIContent("FingerTipMask"), _FingerTips);
                 }
